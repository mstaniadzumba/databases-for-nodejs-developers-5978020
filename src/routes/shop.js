export default async function (fastify) {
  ...
  fastify.get("/:tag?", async (request, reply) => {
    ...
    .skip((page -1) * limit) 
    .limit(limit); //item holds mongodb mongose item. the one we decorated in models or is it in plugin folderf? and this gives us access to the data in this database  collection
